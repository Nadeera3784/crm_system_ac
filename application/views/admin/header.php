    ...
    <div class="wrapper theme-2-active navbar-top-light">
			...
			<div class="fixed-sidebar-left">
				<ul class="nav navbar-nav side-nav nicescroll-bar">
				    <li>
						<a href="<?php echo base_url();?>admin/index"><div class="pull-left"><i class="ti-dashboard mr-20"></i><span class="right-nav-text">Dashboard</span></div><div class="clearfix"></div></a>
					</li>
					...
					<li>
						...
						<ul id="ecom_dr" class="collapse collapse-level-1">
							<li>
								<a href="<?php echo base_url();?>admin/job_list/">List</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>admin/job_progress">Progress</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>admin/job_report">Report</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>admin/job_calendar">Calendar</a>
							</li>
						</ul>
					</li>
					<li>
						...
						<ul id="ui_dr" class="collapse collapse-level-1 two-col-list">
							<li>
								<a href="<?php echo base_url(); ?>admin/attendance_list">List</a>
							</li>
						</ul>
					</li>
					<li>
						<a href="javascript:void(0);" data-toggle="collapse" data-target="#app_dr"><div class="pull-left"><i class="ti-calendar mr-20"></i><span class="right-nav-text">Estimates </span></div><div class="pull-right"><i class="ti-angle-down"></i></div><div class="clearfix"></div></a>
						<ul id="app_dr" class="collapse collapse-level-1">
							<li>
								<a href="<?php echo base_url();?>admin/estimates_list">list</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>admin/estimate_report">Report</a>
							</li>
						</ul>
					</li>
					<li>
						<a href="javascript:void(0);" data-toggle="collapse" data-target="#user_dr"><div class="pull-left"><i class="ti-user   mr-20"></i><span class="right-nav-text">Client </span></div><div class="pull-right"><i class="ti-angle-down "></i></div><div class="clearfix"></div></a>
						<ul id="user_dr" class="collapse collapse-level-1 two-col-list">
							<li>
								<a href="<?php echo base_url(); ?>admin/client_list">List</a>
							</li>
						</ul>
					</li>
					<li>
						<a href="javascript:void(0);" data-toggle="collapse" data-target="#users"><div class="pull-left"><i class="ti-id-badge  mr-20"></i><span class="right-nav-text">Technicians</span></div><div class="pull-right"><i class="ti-angle-down "></i></div><div class="clearfix"></div></a>
						<ul id="users" class="collapse collapse-level-1">
							<li>
								<a href="<?php echo base_url();?>admin/technician_list">List</a>
							</li>
							<li>
								<a href="<?php echo base_url();?>admin/technician_report">Report</a>
							</li>
						</ul>
					</li>
					<li>
