                ...
                <div class="panel panel-default border-panel card-view">
                    ...
                    <div class="panel-wrapper collapse in">
                        <div class="panel-body">
							...
							<?php echo form_open('admin/save_attendance', $attr);?>
                                <div class="form-group">
                                    <label class="control-label mb-10 col-sm-4" for="in_time">In Time :</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="in_time" name="in_time" value="<?=$attendance->in_time;?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="out_time" name="out_time" value="<?=$attendance->out_time;?>">
