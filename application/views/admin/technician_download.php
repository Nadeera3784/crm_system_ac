...
<div style="width:100%; height: 5px; margin-bottom:50px;" class="text-center">
 <p style="text-decoration: underline;  color:#190adc; text-decoration-color: #190adc;"><?php echo ucfirst($report_term);?> Technician's Report - <?php echo $technician->full_name;?></p>
</div>
