               ...
               <?php $this->load->view('notification'); ?>
                ...
                <div class="panel panel-default border-panel card-view">
                   <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark"><?php echo $job->job_id;?> JOB ID</h6>
                        </div>
                        <div class="pull-right">
                           <a href="<?php echo base_url();?>technician/job_list" class="btn btn-sm btn-primary shadow shadow--big">Back</a>
                        </div>
