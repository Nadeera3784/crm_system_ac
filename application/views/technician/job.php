                ...
                <div class="panel panel-default border-panel card-view">
                    ...
                    <div class="panel-wrapper">
                        ...
                        <div class="form-inline mb-30 collapse"  id="filterElement">
                                ...
                                <div class="form-group mr-15">
                                    <label class="control-label mr-10" for="category">Category:</label>
                                ...
                                <div class="form-group mr-15">
                                        <button type="button" name="applyTechnician" id="applyTechnician" class="btn btn-primary">Apply</button>
                                </div>
                        ...
                        <div class="table-wrap">
                                <table class="table mb-0" id="tableTechnicianJob">
                                    <thead>
                                        <tr>
                                           <th>Job ID</th>
                                           <th>Client</th>
