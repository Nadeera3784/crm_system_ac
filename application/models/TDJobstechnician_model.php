...
class TDJobstechnician_model extends CI_Model {
    ...
    private function _get_datatables_query(){
        ...
        $this->db->where('jobs_relation.users_id', $this->user_id); 
    ...
    public function get_datatables(){
        ...
        $this->db->join('jobs_relation', 'jobs.job_id = jobs_relation.jobs_id ', 'INNER');
        $query = $this->db->get();
        return $query->result();
    }
