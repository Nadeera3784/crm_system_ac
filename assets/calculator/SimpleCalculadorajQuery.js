...
jQuery.fn.extend({
    Calculadora: function (op) {
        ...
        defaults = {
            ...
            Signos: ["+", "-", "*", "/"],
            ClaseBtns1: 'primary',
            ClaseBtns2: 'primary btn-outline',
            ClaseBtns3: 'primary btn-outline',
            ClaseColumnas: 'col-md-3 col-xs-3 mbottom',
            ClaseBotones: 'btn-sm btn-block mb-5 btn btn-',
            txtSalida: idInstancia + 'txtResultado',
            ClasetxtSalida: 'form-control txtr',
            InputBorrar: idInstancia + 'Borrar',
            ClaseInputBorrar: 'btn mb-15 btn-default btn-outline btn-sm btn-block',
        ...
        $(LaCalculadora).html(
            '<div class="calculadoraBase">'
             + op.TituloHTML + '<div class=""><div class="" style="margin-bottom: 10px;">' 
             + $(LaCalculadora).html() + '</div></div> </div>');
